...
The `number of followers` of users in Belarus on `2025/2/15 10:35 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
