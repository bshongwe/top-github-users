...
The `number of followers` of users in Belarus on `2025/1/18 6:22 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
