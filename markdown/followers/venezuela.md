...
The `number of followers` of users in Venezuela on `2024/12/25 4:21 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
