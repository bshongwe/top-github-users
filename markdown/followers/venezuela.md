...
The `number of followers` of users in Venezuela on `2025/4/4 12:36 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
