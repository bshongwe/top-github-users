...
The `number of followers` of users in Venezuela on `2025/2/4 2:24 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
