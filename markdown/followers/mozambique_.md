...
The `number of followers` of users in Mozambique  on `2025/4/14 9:53 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
