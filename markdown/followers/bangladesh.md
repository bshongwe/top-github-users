...
The `number of followers` of users in Bangladesh on `2025/1/21 10:54 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
