...
The `number of followers` of users in Iran on `2025/2/28 10:44 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
