...
The `number of followers` of users in Colombia on `2025/3/29 6:24 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
