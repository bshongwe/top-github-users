...
The `number of followers` of users in Colombia on `2025/3/31 6:28 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
