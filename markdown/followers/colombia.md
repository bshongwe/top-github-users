...
The `number of followers` of users in Colombia on `2025/4/4 11:54 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
