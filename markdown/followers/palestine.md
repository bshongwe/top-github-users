...
The `number of followers` of users in Palestine on `2025/3/23 2:53 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
