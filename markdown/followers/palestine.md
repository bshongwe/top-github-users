...
The `number of followers` of users in Palestine on `2025/2/9 8:53 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
