...
The `number of followers` of users in Palestine on `2025/4/10 5:53 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
