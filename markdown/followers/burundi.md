...
The `number of followers` of users in Burundi on `2025/2/23 8:34 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
