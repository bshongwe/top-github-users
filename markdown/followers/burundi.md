...
The `number of followers` of users in Burundi on `2025/1/25 10:17 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
