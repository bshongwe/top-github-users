...
The `number of followers` of users in South Africa on `2025/4/4 5:53 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
