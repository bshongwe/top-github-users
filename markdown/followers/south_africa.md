...
The `number of followers` of users in South Africa on `2025/3/7 4:47 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
