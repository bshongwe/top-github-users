...
The `number of followers` of users in Slovenia on `2025/1/21 11:28 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
