...
The `number of followers` of users in Slovenia on `2025/3/11 6:49 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
