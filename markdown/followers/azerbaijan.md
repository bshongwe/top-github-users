...
The `number of followers` of users in Azerbaijan on `2025/4/9 8:27 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
