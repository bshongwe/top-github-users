...
The `number of followers` of users in Kenya on `2025/4/12 10:53 AM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
