...
The `number of followers` of users in Kenya on `2025/4/14 3:22 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
