...
The `number of followers` of users in Kenya on `2025/2/26 12:35 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
