...
The `number of followers` of users in Croatia on `2025/4/9 5:53 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
