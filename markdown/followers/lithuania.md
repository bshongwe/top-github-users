...
The `number of followers` of users in Lithuania on `2025/1/13 5:53 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
