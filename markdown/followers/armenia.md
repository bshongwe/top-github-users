...
The `number of followers` of users in Armenia on `2025/3/9 5:54 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
