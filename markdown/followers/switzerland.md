...
The `number of followers` of users in Switzerland on `2025/1/31 4:22 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
