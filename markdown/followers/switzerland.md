...
The `number of followers` of users in Switzerland on `2024/12/31 6:47 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
