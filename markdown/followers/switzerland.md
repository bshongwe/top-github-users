...
The `number of followers` of users in Switzerland on `2025/2/17 11:30 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
