...
The `number of followers` of users in Finland on `2025/1/3 1:15 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
