...
The `number of followers` of users in Finland on `2025/2/12 1:34 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
