...
The `number of followers` of users in Finland on `2025/2/22 8:42 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
