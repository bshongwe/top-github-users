...
The `number of followers` of users in Finland on `2025/2/10 1:35 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
