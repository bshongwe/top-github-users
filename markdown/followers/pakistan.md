...
The `number of followers` of users in Pakistan on `2025/2/21 2:34 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
