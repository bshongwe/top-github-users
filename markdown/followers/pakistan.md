...
The `number of followers` of users in Pakistan on `2025/3/21 2:53 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
