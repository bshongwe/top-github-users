...
The `number of followers` of users in Mauritania on `2025/1/7 8:45 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
