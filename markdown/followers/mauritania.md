...
The `number of followers` of users in Mauritania on `2025/2/7 6:25 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
