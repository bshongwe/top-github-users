...
The `number of followers` of users in Mauritania on `2025/2/9 3:07 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
