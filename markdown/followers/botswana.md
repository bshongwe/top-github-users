...
The `number of followers` of users in Botswana on `2025/3/26 7:29 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
