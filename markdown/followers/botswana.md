...
The `number of followers` of users in Botswana on `2025/3/1 8:19 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
