...
The `number of followers` of users in Botswana on `2025/3/18 4:56 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
