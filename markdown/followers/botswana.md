...
The `number of followers` of users in Botswana on `2025/4/11 5:18 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
