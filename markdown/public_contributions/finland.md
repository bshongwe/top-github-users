...
The `public contributions` by users in Finland on `2025/2/18 8:55 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
