...
The `public contributions` by users in Finland on `2024/12/26 9:40 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
