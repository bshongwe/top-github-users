...
The `public contributions` by users in Bulgaria on `2025/1/18 8:41 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
