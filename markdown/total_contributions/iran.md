...
The `public contributions` and `private contributions` by users in Iran on `2025/2/24 8:56 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
