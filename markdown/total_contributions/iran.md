...
The `public contributions` and `private contributions` by users in Iran on `2025/3/4 11:17 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
