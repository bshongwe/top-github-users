...
The `public contributions` and `private contributions` by users in Lithuania on `2025/3/21 5:53 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
