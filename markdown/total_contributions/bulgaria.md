...
The `public contributions` and `private contributions` by users in Bulgaria on `2025/3/24 1:54 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
