...
The `public contributions` and `private contributions` by users in Tanzania on `2025/3/3 9:22 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
