...
The `public contributions` and `private contributions` by users in Egypt on `2025/1/29 11:31 PM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
