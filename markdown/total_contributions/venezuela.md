...
The `public contributions` and `private contributions` by users in Venezuela on `2025/1/10 7:32 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
