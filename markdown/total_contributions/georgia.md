...
The `public contributions` and `private contributions` by users in Georgia on `2025/1/22 11:40 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
