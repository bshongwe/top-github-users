...
The `public contributions` and `private contributions` by users in Ukraine on `2025/4/8 10:44 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
