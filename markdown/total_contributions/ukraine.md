...
The `public contributions` and `private contributions` by users in Ukraine on `2025/3/11 11:31 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
